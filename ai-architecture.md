...
- *Implementation Context: [Software Architecture](software-architecture.md)*
- *Agent System: [Prompt Chain Design](prompt-chain.md)*
- *Data Structures: [Data Model](data-model.md)*
- *Example Usage: [User Stories](user-stories.md)*
...
*For practical system implementation details, see [Software Architecture](software-architecture.md#core-components)*
...
*Related: See [Static Analysis Tool](static-analysis-tool-prompt.md) for concrete implementation of code analysis patterns*
...
*Related: See [Data Model](data-model.md#vector-storage) for vector storage implementation details*
...
*Related: See [Prompt Chain Design](prompt-chain.md) for specialized agent implementation details*
...
*Related: See [Context Pack Format](context-pack.txt) for how relationships are represented in context packs*
